...
export async function executeSelfCalibratingWorkflow(
  ...
  let matchingResult;
  try {
    matchingResult = await matchTexts(geminiResults, cloudVisionResults, geminiApiKey);
