...
if [ ! -f .env.production ]; then
    echo -e "\033[0;31m[ERROR]\033[0m .env.production not found"
...
if ! docker info > /dev/null 2>&1; then
    echo -e "\033[0;31m[ERROR]\033[0m Docker is not running"
    echo "Please start Docker Desktop and try again"
    exit 1
fi

echo -e "\033[0;36m[START]\033[0m Starting all services..."
echo ""
...
echo ""
echo -e "\033[0;34m[STATUS]\033[0m Service Status:"
echo ""
docker compose -f docker-compose.production.yml ps

echo ""
echo -e "\033[0;32m[OK]\033[0m All services started!"
echo ""
echo "========================================="
